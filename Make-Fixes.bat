...
call :fix       DEMO        D256HZ
call :fix       DEMO        SMACK
call :fix       DEMO        UNITY
call :fix       GAME256     BREAKOUT
call :fix       GAME256     CACTUSBI
call :fix       GAME256     RUSHHOUR
call :fix       GAME256     TINYCRAW
call :fix       GAME256     UFOSLALO
call :fix       INTRO16K    GTXFTOP
call :fix       INTRO256    CHRYS256
call :fix       INTRO256    SVSE2022
call :fix       INTRO256    PARTYZAN
call :fix       MSX         ATARIADV
call :fix       MSX         INSOMNIA
goto :eof
